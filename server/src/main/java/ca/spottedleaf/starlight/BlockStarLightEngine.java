...
public final class BlockStarLightEngine extends StarLightEngine {
    ...
    protected void setNibbleNull(int chunkX, int chunkY, int chunkZ) {
        final SWMRNibbleArray nibble = getNibbleFromCache(chunkX, chunkY, chunkZ);
        if (nibble != null) {
    ...
    protected void initNibble(int chunkX, int chunkY, int chunkZ, boolean extrude, boolean initRemovedNibbles) {
        if (chunkY < minLightSection || chunkY > maxLightSection || getChunkInCache(chunkX, chunkZ) == null) return;
