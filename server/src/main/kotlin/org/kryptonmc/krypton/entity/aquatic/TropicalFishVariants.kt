...
object TropicalFishVariants {
     ...
     */
    @JvmStatic
    fun encodeVariant(variant: TropicalFishVariant, baseColor: DyeColor, patternColor: DyeColor): Int {
    ...
    @JvmStatic
    fun modifyVariant(encoded: Int, variant: TropicalFishVariant): Int {
    ...
    @JvmStatic
    fun modifyBaseColor(encoded: Int, baseColor: DyeColor): Int {
    ...
    @JvmStatic
    fun modifyPatternColor(encoded: Int, patternColor: DyeColor): Int {
    ...
    @JvmStatic
    fun extractBaseColor(variant: Int): DyeColor = Registries.DYE_COLORS[(variant and 16711680) shr 16]!!

    // -16777216 = 11111111 00000000 00000000 00000000 (clear all bits except 24-31)
    @JvmStatic
    fun extractPatternColor(encoded: Int): DyeColor = Registries.DYE_COLORS[(encoded and -16777216) shr 24]!!
    ...
    @JvmStatic
    fun extractVariant(encoded: Int): TropicalFishVariant = VARIANTS[min(encoded and 255, 1) + 6 * min((encoded and 65280) shr 8, 5)]
}
