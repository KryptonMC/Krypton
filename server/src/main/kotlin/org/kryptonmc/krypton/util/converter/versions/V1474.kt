...
object V1474 {
    ...
    private const val VERSION = MCVersions.V18W10B

    fun register() {
        MCTypeRegistry.ENTITY.addConverterForId("minecraft:shulker", VERSION) { data, _, _ ->
            if (data.getInt("Color") == 1) data.setByte("Color", 16)
            null
        }
