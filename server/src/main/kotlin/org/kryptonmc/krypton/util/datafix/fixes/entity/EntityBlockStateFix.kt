...
class EntityBlockStateFix(outputSchema: Schema, changesType: Boolean) : DataFix(outputSchema, changesType) {
    ...
    override fun makeRule(): TypeRewriteRule {
        ...
        return fixTypeEverywhereTyped("EntityBlockStateFix", inputSchema.getType(References.ENTITY), outputSchema.getType(References.ENTITY)) { typed ->
            ...
            temp = temp.updateEntity("minecraft:arrow", displayUpdater)
            temp = temp.updateEntity("minecraft:spectral_arrow", displayUpdater)
            temp = temp.updateEntity("minecraft:egg", displayUpdater)
            temp = temp.updateEntity("minecraft:ender_pearl", displayUpdater)
            temp = temp.updateEntity("minecraft:fireball", displayUpdater)
            temp = temp.updateEntity("minecraft:potion", displayUpdater)
            temp = temp.updateEntity("minecraft:small_fireball", displayUpdater)
            temp = temp.updateEntity("minecraft:snowball", displayUpdater)
            temp = temp.updateEntity("minecraft:wither_skull", displayUpdater)
            temp = temp.updateEntity("minecraft:xp_bottle", displayUpdater)
