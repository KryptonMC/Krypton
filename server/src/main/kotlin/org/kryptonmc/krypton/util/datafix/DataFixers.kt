...
object DataFixers {
    ...
    private val EXECUTOR = Executors.newFixedThreadPool(
        (Runtime.getRuntime().availableProcessors() - 2).clamp(1, 8),
        threadFactory("Data Fixer Worker #%d")
    )

    private val FIXER: DataFixer = DataFixerBuilder(KryptonPlatform.worldVersion).apply {
        ...
        addSchema(502, SAME).apply {
            addFixer(RenameItemFix(this, "cooked_fish item renamer") {
                if (it.ensureNamespaced() == "minecraft:cooked_fished") "minecraft:cooked_fish" else it
            })
        ...
        addSchema(820, SAME_NAMESPACED).apply {
            addFixer(RenameItemFix(this, "Totem item renamer", rename(
                "minecraft:totem" to "minecraft:totem_of_undying"
            )))
        }
        ...
        addSchema(1474, SAME_NAMESPACED).apply {
            ...
            addFixer(RenameBlockFix(this, "Colourless shulker block fixer") {
                if (it.ensureNamespaced() == "minecraft:purple_shulker_box") "minecraft:shulker_box" else it
            })
            addFixer(RenameItemFix(this, "Colourless shulker item fixer") {
                if (it.ensureNamespaced() == "minecraft:purple_shulker_box") "minecraft:shulker_box" else it
            })
        }
        ...
        addSchema(1488, SAME_NAMESPACED).apply {
            addFixer(RenameBlockFix(this, "Rename kelp/kelp_top", rename(mapOf(
            ...
            addFixer(object : NamedEntityFix(
                this,
                false,
        ...
        addSchema(2100, ::V2100).apply {
            ...
            addFixer(RenameRecipesFix(this, false, "Rename sugar recipe", rename(
                "minecraft:sugar" to "sugar_from_sugar_cane"
            )))
            addFixer(RenameAdvancementsFix(this, false, "Rename sugar recipe advancement", rename(
                "minecraft:recipes/misc/sugar" to "minecraft:recipes/misc/sugar_from_sugar_cane"
            )))
        }
        ...
        addSchema(2209, SAME_NAMESPACED).apply {
            addFixer(RenameItemFix(this, "Rename bee_hive item to beehive", rename(
                "minecraft:bee_hive" to "minecraft:beehive"
            )))
            addFixer(RenameBeehivePOIFix(this))
            addFixer(RenameBlockFix(this, "Rename bee_hive block to beehive", rename(
                "minecraft:bee_hive" to "minecraft:beehive"
            )))
        }
        ...
        addSchema(2503, SAME_NAMESPACED).apply {
            ...
            addFixer(RenameAdvancementsFix(this, false, "Composter category change", rename(
                "minecraft:recipes/misc/composter" to "minecraft:recipes/decorations/composter"
            )))
        }
        ...
        addSchema(2552, SAME_NAMESPACED).apply {
            addFixer(RenameBiomesFix(this, false, "Nether biome rename", mapOf(
                "minecraft:nether" to "minecraft:nether_wastes"
            )))
        }
        ...
        addSchema(2680, SAME_NAMESPACED).apply {
            addFixer(RenameItemFix(this, "Renamed grass path item to dirt path", rename(
                "minecraft:grass_path" to "minecraft:dirt_path"
            )))
            addFixer(RenameBlockWithJigsawFix(this, "Renamed grass path block to dirt path", rename(
                "minecraft:grass_path" to "minecraft:dirt_path"
            )))
        }
        ...
        addSchema(2710, SAME_NAMESPACED).apply {
            addFixer(RenameStatsFix(this, "Renamed play_one_minute stat to play_time", mapOf(
                "minecraft:play_one_minute" to "minecraft:play_time"
            )))
        }
        addSchema(2717, SAME_NAMESPACED).apply {
            addFixer(RenameItemFix(this, "Rename azalea_leaves_flowers", rename(
                "minecraft:azalea_leaves_flowers" to "minecraft:flowering_azalea_leaves"
            )))
            addFixer(RenameBlockFix(this, "Rename azalea_leaves_flowers items", rename(
                "minecraft:azalea_leaves_flowers" to "minecraft:flowering_azalea_leaves"
            )))
        }
    }.build(EXECUTOR)

    private val RENAMED_DYE_ITEMS = mapOf(
    ...
    private val RENAMED_CORAL_FANS = mapOf(
        ...
        "minecraft:fire_coral_fan" to "minecraft:fire_coral_wall_fan",
        "minecraft:horn_coral_fan" to "minecraft:horn_coral_wall_fan",
    )

    private val RENAMED_CORALS = mapOf(
