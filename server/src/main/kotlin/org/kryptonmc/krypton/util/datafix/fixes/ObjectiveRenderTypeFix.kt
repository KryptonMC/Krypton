...
class ObjectiveRenderTypeFix(outputSchema: Schema, changesType: Boolean) : DataFix(outputSchema, changesType) {
    ...
    private fun String.toRenderType() = if (this == "health") RenderType.HEARTS else RenderType.INTEGER
}
