...
object ChickenData {
    ...
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMutable(Keys.IS_JOCKEY, KryptonChicken::isJockey) { holder, value -> holder.isJockey = value }
        registrar.registerMutable(Keys.EGG_COOLDOWN_TIME, KryptonChicken::eggCooldownTime) { holder, value -> holder.eggCooldownTime = value }
    }
}
