...
object ExperienceOrbData {

    @JvmStatic
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMutable(Keys.AGE, KryptonExperienceOrb::age) { holder, value -> holder.age = value }
        registrar.registerMutable(Keys.EXPERIENCE, KryptonExperienceOrb::experience) { holder, value -> holder.experience = value }
    }
}
