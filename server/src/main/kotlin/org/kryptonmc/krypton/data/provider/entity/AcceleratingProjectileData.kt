...
object AcceleratingProjectileData {

    @JvmStatic
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMutable(Keys.ACCELERATION, KryptonAcceleratingProjectile::acceleration) { holder, value -> holder.acceleration = value }
    }
}
