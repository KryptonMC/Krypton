...
object ZombieData {
    ...
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMetadata<KryptonZombie, _>(Keys.IS_BABY, MetadataKeys.ZOMBIE.BABY)
        registrar.registerMetadata<KryptonZombie, _>(Keys.IS_CONVERTING, MetadataKeys.ZOMBIE.CONVERTING)
    }
}
