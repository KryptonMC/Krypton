...
object FurnaceMinecartData {

    @JvmStatic
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMetadata<KryptonFurnaceMinecart, _>(Keys.HAS_FUEL, MetadataKeys.FURNACE_MINECART.HAS_FUEL)
        registrar.registerMutable(Keys.FUEL, KryptonFurnaceMinecart::fuel) { holder, value -> holder.fuel = value }
    }
}
