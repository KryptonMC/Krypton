...
object TamableData {
    ...
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerFlag<KryptonTamable>(Keys.IS_SITTING, MetadataKeys.TAMABLE.FLAGS, 0)
        registrar.registerFlag<KryptonTamable>(Keys.IS_TAMED, MetadataKeys.TAMABLE.FLAGS, 2)
        registrar.registerMetadata<KryptonTamable, _>(Keys.TAMER, MetadataKeys.TAMABLE.OWNER)
    }
}
