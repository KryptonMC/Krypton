...
object ShulkerBulletData {

    @JvmStatic
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMutable(Keys.STEPS, KryptonShulkerBullet::steps)
        registrar.registerMutable(Keys.TARGET, KryptonShulkerBullet::target)
    }
}
