...
object AnimalData {
    ...
    fun register(registrar: DataProviderRegistrar) {
        registrar.registerMutable(Keys.LOVE_CAUSE, KryptonAnimal::loveCause) { holder, value -> holder.loveCause = value }
        registrar.registerMutable(Keys.IN_LOVE_TIME, KryptonAnimal::inLoveTime) { holder, value -> holder.inLoveTime = value }
    }
}
