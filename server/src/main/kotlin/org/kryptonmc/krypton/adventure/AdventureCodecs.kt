    ...
    val STYLE_FORMATTING: CompoundCodec<Style> = CompoundCodec.of(
        ...
        },
        {
            Style.style()
                ...
                .decoration(TextDecoration.ITALIC, it.getDecorationState("italic"))
                .decoration(TextDecoration.UNDERLINED, it.getDecorationState("underlined"))
                .decoration(TextDecoration.STRIKETHROUGH, it.getDecorationState("strikethrough"))
                .decoration(TextDecoration.OBFUSCATED, it.getDecorationState("obfuscated"))
