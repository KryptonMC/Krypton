...
object KryptonBiomes {
    ...
    init {
        ...
        register(
            BiomeKeys.RIVER,
            7,
            BuiltInBiomes.river(-0.5F, 0F, 0.5F, 4159204, false)
        )
        ...
        register(
            ...
            11,
            BuiltInBiomes.river(-0.5F, 0F, 0F, 3750089, true)
        )
        ...
        register(
            ...
            32,
            BuiltInBiomes.giantTreeTaiga(0.2F, 0.2F, 0.3F)
        )
        register(
            BiomeKeys.GIANT_TREE_TAIGA_HILLS,
            33,
            BuiltInBiomes.giantTreeTaiga(0.45F, 0.3F, 0.3F)
        )
        ...
        register(
            ...
            160,
            BuiltInBiomes.giantTreeTaiga(0.2F, 0.2F, 0.25F)
        )
        register(
        ...
        register(
            ...
            163,
            BuiltInBiomes.savanna(0.3625F, 1.225F, 1.1F)
        )
        register(
            BiomeKeys.SHATTERED_SAVANNA_PLATEAU,
            164,
            BuiltInBiomes.savanna(1.05F, 1.2125001F, 1F)
        )
