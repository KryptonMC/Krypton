...
object KryptonBiomes {
    ...
    val PLAINS = register(BiomeKeys.PLAINS, 1, BuiltInBiomes.plains(false))
    ...
    init {
        ...
        register(BiomeKeys.TAIGA, 5, BuiltInBiomes.taiga(0.2F, 0.2F, false, false))
        ...
        register(BiomeKeys.TAIGA_HILLS, 19, BuiltInBiomes.taiga(0.45F, 0.3F, false, false))
        ...
        register(BiomeKeys.SNOWY_TAIGA, 30, BuiltInBiomes.taiga(0.2F, 0.2F, true, false))
        register(BiomeKeys.SNOWY_TAIGA_HILLS, 31, BuiltInBiomes.taiga(0.45F, 0.3F, true, false))
        register(BiomeKeys.GIANT_TREE_TAIGA, 32, BuiltInBiomes.giantTreeTaiga(0.2F, 0.2F, 0.3F, false))
        register(BiomeKeys.GIANT_TREE_TAIGA_HILLS, 33, BuiltInBiomes.giantTreeTaiga(0.45F, 0.3F, 0.3F, false))
        ...
        register(BiomeKeys.WARM_OCEAN, 44, BuiltInBiomes.warmOcean())
        ...
        register(BiomeKeys.DEEP_WARM_OCEAN, 47, BuiltInBiomes.deepWarmOcean())
        ...
        register(BiomeKeys.SUNFLOWER_PLAINS, 129, BuiltInBiomes.plains(true))
        ...
        register(BiomeKeys.TAIGA_MOUNTAINS, 133, BuiltInBiomes.taiga(0.3F, 0.4F, false, true))
        ...
        register(BiomeKeys.SNOWY_TAIGA_MOUNTAINS, 158, BuiltInBiomes.taiga(0.3F, 0.4F, true, true))
        register(BiomeKeys.GIANT_SPRUCE_TAIGA, 160, BuiltInBiomes.giantTreeTaiga(0.2F, 0.2F, 0.25F, true))
        register(BiomeKeys.GIANT_SPRUCE_TAIGA_HILLS, 161, BuiltInBiomes.giantTreeTaiga(0.2F, 0.2F, 0.25F, true))
