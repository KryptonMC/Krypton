...
class RegionFileManager(
    ...
    private fun getRegionFile(position: ChunkPosition): RegionFile {
        val serialized = position.regionX combineWith position.regionZ
    ...
    companion object {
        ...
        private val LOGGER = logger<RegionFileManager>()
    }
}

private infix fun Int.combineWith(other: Int): Long =
    (((this.toLong() and 0xFFFFFFFF) or (other.toLong() and 0xFFFFFFFF)) shl 32)