...
public object Biomes {
    ...
    @JvmField public val SNOWY_PLAINS: Biome = get("snowy_plains")
    ...
    @JvmField public val OLD_GROWTH_BIRCH_FOREST: Biome = get("old_growth_birch_forest")
    @JvmField public val OLD_GROWTH_PINE_TAIGA: Biome = get("old_growth_pine_taiga")
    @JvmField public val OLD_GROWTH_SPRUCE_TAIGA: Biome = get("old_growth_spruce_taiga")
    ...
    @JvmField public val WINDSWEPT_HILLS: Biome = get("windswept_hills")
    @JvmField public val WINDSWEPT_GRAVELLY_HILLS: Biome = get("windswept_gravelly_hills")
    @JvmField public val WINDSWEPT_FOREST: Biome = get("windswept_forest")
    @JvmField public val WINDSWEPT_SAVANNA: Biome = get("windswept_savanna")
    @JvmField public val JUNGLE: Biome = get("jungle")
    @JvmField public val SPARSE_JUNGLE: Biome = get("sparse_jungle")
    ...
    @JvmField public val WOODED_BADLANDS: Biome = get("wooded_badlands")
    @JvmField public val MEADOW: Biome = get("meadow")
    @JvmField public val GROVE: Biome = get("grove")
    @JvmField public val SNOWY_SLOPES: Biome = get("snowy_slopes")
    @JvmField public val FROZEN_PEAKS: Biome = get("frozen_peaks")
    @JvmField public val JAGGED_PEAKS: Biome = get("jagged_peaks")
    @JvmField public val STONY_PEAKS: Biome = get("stony_peaks")
    ...
    @JvmField public val STONY_SHORE: Biome = get("stony_shore")
