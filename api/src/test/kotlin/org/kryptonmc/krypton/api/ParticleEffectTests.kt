...
import org.kryptonmc.krypton.api.effect.particle.DirectionalParticleEffectBuilder
...
import org.kryptonmc.krypton.api.effect.particle.ParticleEffectBuilder
...
class ParticleEffectTests {
    ...
    private val particle = mockk<Particle> {
        every { key } returns NamespacedKey("krypton", "test")
        every { id } returns 0
    }
