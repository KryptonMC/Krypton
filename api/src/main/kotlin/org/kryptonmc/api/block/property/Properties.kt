...
object Properties {
    ...
    @JvmField val LIQUID_LEVEL = Property.forInt("level", 0..15)
    ...
    @JvmField val FACE = Property.forEnum("face", AttachFace.values())
    ...
    @JvmField val HINGE = Property.forEnum("hinge", DoorHingeSide.values())
    @JvmField val INSTRUMENT = Property.forEnum("instrument", NoteBlockInstrument.values())
    @JvmField val LEAVES = Property.forEnum("leaves", BambooLeaves.values())
    ...
    @JvmField val PART = Property.forEnum("part", BedPart.values())
