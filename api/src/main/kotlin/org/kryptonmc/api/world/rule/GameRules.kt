...
public object GameRules {
     ...
     */
    @JvmField
    public val ANNOUNCE_ADVANCEMENTS: RegistryReference<GameRule<Boolean>> = get("announce_advancements")
     ...
     */
    @JvmField
    public val COMMAND_BLOCK_OUTPUT: RegistryReference<GameRule<Boolean>> = get("command_block_output")
     ...
     */
    @JvmField
    public val DISABLE_ELYTRA_MOVEMENT_CHECK: RegistryReference<GameRule<Boolean>> = get("disable_elytra_movement_check")
     ...
     */
    @JvmField
    public val DISABLE_RAIDS: RegistryReference<GameRule<Boolean>> = get("disable_raids")
     ...
     */
    @JvmField
    public val DO_DAYLIGHT_CYCLE: RegistryReference<GameRule<Boolean>> = get("do_daylight_cycle")
     ...
     */
    @JvmField
    public val DO_ENTITY_DROPS: RegistryReference<GameRule<Boolean>> = get("do_entity_drops")
     ...
     */
    @JvmField
    public val DO_FIRE_TICK: RegistryReference<GameRule<Boolean>> = get("do_fire_tick")
     ...
     */
    @JvmField
    public val DO_INSOMNIA: RegistryReference<GameRule<Boolean>> = get("do_insomnia")
     ...
     */
    @JvmField
    public val DO_IMMEDIATE_RESPAWN: RegistryReference<GameRule<Boolean>> = get("do_immediate_respawn")
     ...
     */
    @JvmField
    public val DO_LIMITED_CRAFTING: RegistryReference<GameRule<Boolean>> = get("do_limited_crafting")
     ...
     */
    @JvmField
    public val DO_MOB_LOOT: RegistryReference<GameRule<Boolean>> = get("do_mob_loot")
     ...
     */
    @JvmField
    public val DO_MOB_SPAWNING: RegistryReference<GameRule<Boolean>> = get("do_mob_spawning")
     ...
     */
    @JvmField
    public val DO_PATROL_SPAWNING: RegistryReference<GameRule<Boolean>> = get("do_patrol_spawning")
     ...
     */
    @JvmField
    public val DO_TILE_DROPS: RegistryReference<GameRule<Boolean>> = get("do_tile_drops")
     ...
     */
    @JvmField
    public val DO_TRADER_SPAWNING: RegistryReference<GameRule<Boolean>> = get("do_trader_spawning")
     ...
     */
    @JvmField
    public val DO_WEATHER_CYCLE: RegistryReference<GameRule<Boolean>> = get("do_weather_cycle")
     ...
     */
    @JvmField
    public val DROWNING_DAMAGE: RegistryReference<GameRule<Boolean>> = get("drowning_damage")
     ...
     */
    @JvmField
    public val FALL_DAMAGE: RegistryReference<GameRule<Boolean>> = get("fall_damage")
     ...
     */
    @JvmField
    public val FIRE_DAMAGE: RegistryReference<GameRule<Boolean>> = get("fire_damage")
     ...
     */
    @JvmField
    public val FORGIVE_DEAD_PLAYERS: RegistryReference<GameRule<Boolean>> = get("forgive_dead_players")
     ...
     */
    @JvmField
    public val KEEP_INVENTORY: RegistryReference<GameRule<Boolean>> = get("keep_inventory")
     ...
     */
    @JvmField
    public val LOG_ADMIN_COMMANDS: RegistryReference<GameRule<Boolean>> = get("log_admin_commands")
     ...
     */
    @JvmField
    public val MAX_COMMAND_CHAIN_LENGTH: RegistryReference<GameRule<Int>> = get("max_command_chain_length")
     ...
     */
    @JvmField
    public val MAX_ENTITY_CRAMMING: RegistryReference<GameRule<Int>> = get("max_entity_cramming")
     ...
     */
    @JvmField
    public val MOB_GRIEFING: RegistryReference<GameRule<Boolean>> = get("mob_griefing")
     ...
     */
    @JvmField
    public val NATURAL_REGENERATION: RegistryReference<GameRule<Boolean>> = get("natural_regeneration")
     ...
     */
    @JvmField
    public val RANDOM_TICK_SPEED: RegistryReference<GameRule<Int>> = get("random_tick_speed")
     ...
     */
    @JvmField
    public val REDUCED_DEBUG_INFO: RegistryReference<GameRule<Boolean>> = get("reduced_debug_info")
     ...
     */
    @JvmField
    public val SEND_COMMAND_FEEDBACK: RegistryReference<GameRule<Boolean>> = get("send_command_feedback")
     ...
     */
    @JvmField
    public val SHOW_DEATH_MESSAGES: RegistryReference<GameRule<Boolean>> = get("show_death_messages")
     ...
     */
    @JvmField
    public val SPAWN_RADIUS: RegistryReference<GameRule<Int>> = get("spawn_radius")
     ...
     */
    @JvmField
    public val SPECTATORS_GENERATE_CHUNKS: RegistryReference<GameRule<Boolean>> = get("spectators_generate_chunks")
     ...
     */
    @JvmField
    public val UNIVERSAL_ANGER: RegistryReference<GameRule<Boolean>> = get("universal_anger")

    @JvmStatic
    private fun <V : Any> get(name: String): RegistryReference<GameRule<V>> = RegistryReference.of(Registries.GAME_RULES, Key.key(name))
}
