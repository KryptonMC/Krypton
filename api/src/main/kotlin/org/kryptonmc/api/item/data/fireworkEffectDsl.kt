...
public inline fun fireworkEffect(
    type: FireworkEffectType,
    builder: FireworkEffect.Builder.() -> Unit
): FireworkEffect = FireworkEffect.builder(type).apply(builder).build()
