...
public interface BannerMeta : ScopedItemMeta<BannerMeta>, ItemMetaBuilder.Provider<BannerMeta.Builder> {
    ...
    public fun withPatterns(patterns: Iterable<BannerPattern>): BannerMeta
    ...
    public interface Builder : ItemMetaBuilder<Builder, BannerMeta> {
        ...
        public fun patterns(patterns: Iterable<BannerPattern>): Builder
