...
fun TypeSpec.Builder.registryGetter(returnType: TypeName, registryName: String): TypeSpec.Builder =
...
inline fun TypeSpec.Builder.staticFunction(
    name: String,
    returnType: TypeName,
    modifier: KModifier,
    builder: FunSpec.Builder.() -> Unit = {}
): TypeSpec.Builder = addFunction(FunSpec.builder(name).returns(returnType).addModifiers(modifier).jvmStatic().apply(builder).build())
